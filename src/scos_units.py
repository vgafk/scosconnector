...
class EducationalProgram(ScosUnit):
    ...
    def __init__(self, base_id: int, title: str, direction: str, code_direction: str, start_year: str, end_year: str,
                 external_id: str = str(uuid4()), scos_id: str = '',
                 action: Actions = Actions.INSERT):
        self.id = base_id
